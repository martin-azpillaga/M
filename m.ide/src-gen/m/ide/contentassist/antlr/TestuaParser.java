...
import m.ide.contentassist.antlr.internal.InternalTestuaParser;
import m.services.TestuaGrammarAccess;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class TestuaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(TestuaGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TestuaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBranchAccess().getGroup_4(), "rule__Branch__Group_4__0");
			...
			builder.put(grammarAccess.getLoopAccess().getEntityAssignment_1(), "rule__Loop__EntityAssignment_1");
			builder.put(grammarAccess.getLoopAccess().getConstraintsAssignment_3_3(), "rule__Loop__ConstraintsAssignment_3_3");
			builder.put(grammarAccess.getLoopAccess().getCommandsAssignment_5(), "rule__Loop__CommandsAssignment_5");
			builder.put(grammarAccess.getBranchAccess().getIfAssignment_2(), "rule__Branch__IfAssignment_2");
			builder.put(grammarAccess.getBranchAccess().getElseIfsAssignment_3_1(), "rule__Branch__ElseIfsAssignment_3_1");
			builder.put(grammarAccess.getBranchAccess().getCommandsAssignment_4_2(), "rule__Branch__CommandsAssignment_4_2");
	...
	@Override
	protected InternalTestuaParser createParser() {
		InternalTestuaParser result = new InternalTestuaParser(null);
