...
public class InternalJsonLexer extends Lexer {
    ...
    public final void mT__9() throws RecognitionException {
        try {
            ...
            // InternalJson.g:11:6: ( 'true' )
            // InternalJson.g:11:8: 'true'
            {
            match("true"); 
    ...
    public final void mT__10() throws RecognitionException {
        try {
            int _type = T__10;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:12:7: ( 'false' )
            // InternalJson.g:12:9: 'false'
            {
            match("false"); 
    ...
    public final void mRULE_LONG() throws RecognitionException {
        try {
            int _type = RULE_LONG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:997:11: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalJson.g:997:13: ( '-' )? ( '0' .. '9' )+
            {
            // InternalJson.g:997:13: ( '-' )?
            int alt1=2;
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:999:12: ( ( '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( 'e' ( '-' )? ( '0' .. '9' )+ )? )
            // InternalJson.g:999:14: ( '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( 'e' ( '-' )? ( '0' .. '9' )+ )?
            {
            // InternalJson.g:999:14: ( '-' )?
            int alt3=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalJson.g:999:48: 'e' ( '-' )? ( '0' .. '9' )+
                    {
                    match('e'); 
                    // InternalJson.g:999:52: ( '-' )?
                    int alt6=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:1001:13: ( '\"' (~ ( '\"' ) )* '\"' )
            // InternalJson.g:1001:15: '\"' (~ ( '\"' ) )* '\"'
            {
            match('\"'); 
            // InternalJson.g:1001:19: (~ ( '\"' ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WHITE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:1003:18: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalJson.g:1003:20: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalJson.g:1003:20: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJson.g:1005:9: ( ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '.' | '-' )* )
            // InternalJson.g:1005:11: ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '.' | '-' )*
            {
            ...
            // InternalJson.g:1005:44: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '.' | '-' )*
            loop11:
            do {
                int alt11=2;
    ...
    static final String DFA12_eotS =
        "\1\uffff\2\16\7\uffff\1\23\4\uffff\2\16\1\23\1\16\1\uffff\1\23\2\16\1\13\1\33\2\16\1\uffff\1\37\1\16\1\13\1\uffff";
    static final String DFA12_eofS =
        "\40\uffff";
    static final String DFA12_minS =
        "\1\11\1\162\1\141\6\uffff\1\56\1\55\4\uffff\1\165\1\154\1\56\1\60\1\uffff\1\55\1\145\1\163\2\55\1\145\1\55\1\uffff\1\55\1\60\1\55\1\uffff";
    static final String DFA12_maxS =
        "\1\175\1\162\1\141\6\uffff\1\71\1\172\4\uffff\1\165\1\154\2\71\1\uffff\1\172\1\145\1\163\2\172\1\145\1\71\1\uffff\1\172\1\71\1\172\1\uffff";
    static final String DFA12_acceptS =
        "\3\uffff\1\3\1\4\1\5\1\6\1\7\1\10\2\uffff\1\12\1\13\1\14\1\15\4\uffff\1\11\7\uffff\1\1\3\uffff\1\2";
    static final String DFA12_specialS =
        "\40\uffff}>";
    static final String[] DFA12_transitionS = {
            "\2\15\2\uffff\1\15\22\uffff\1\15\1\uffff\1\14\11\uffff\1\5\1\11\1\13\1\uffff\12\12\1\6\6\uffff\32\16\1\7\1\uffff\1\10\1\uffff\1\16\1\uffff\5\16\1\2\15\16\1\1\6\16\1\3\1\uffff\1\4",
            "\1\17",
            "\1\20",
            "",
            "",
