...
import m.ide.contentassist.antlr.internal.InternalTextParser;
...
public class TextParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TextGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLoopAccess().getEntityAssignment_3(), "rule__Loop__EntityAssignment_3");
			builder.put(grammarAccess.getLoopAccess().getConstraintsAssignment_4_1(), "rule__Loop__ConstraintsAssignment_4_1");
			builder.put(grammarAccess.getLoopAccess().getCommandsAssignment_6(), "rule__Loop__CommandsAssignment_6");
			builder.put(grammarAccess.getBranchAccess().getIfAssignment_1(), "rule__Branch__IfAssignment_1");
			builder.put(grammarAccess.getBranchAccess().getElseIfsAssignment_2_2(), "rule__Branch__ElseIfsAssignment_2_2");
			builder.put(grammarAccess.getBranchAccess().getCommandsAssignment_3_2(), "rule__Branch__CommandsAssignment_3_2");
