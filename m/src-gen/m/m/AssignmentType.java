 ...
 * <!-- end-user-doc -->
 * @see m.m.MPackage#getAssignmentType()
 * @model
 * @generated
 */
public enum AssignmentType implements Enumerator
{
   ...
   * <!-- end-user-doc -->
   * @see #SHIFT_LEFT
   * @model name="shiftLeft" literal="<<="
   * @generated
   * @ordered
   */
  public static final int SHIFT_LEFT_VALUE = 9;
   ...
   * <!-- end-user-doc -->
   * @see #SHIFT_RIGHT
   * @model name="shiftRight" literal=">>="
   * @generated
   * @ordered
   */
  public static final int SHIFT_RIGHT_VALUE = 10;
