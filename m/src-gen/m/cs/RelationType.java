 ...
 * <!-- end-user-doc -->
 * @see m.cs.CsPackage#getRelationType()
 * @model
 * @generated
 */
public enum RelationType implements Enumerator
{
  ...
  /**
   * The '<em><b>Overorequal</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #OVEROREQUAL_VALUE
   * @generated
   * @ordered
   */
  OVEROREQUAL(4, "overorequal", ">="),

  /**
   * The '<em><b>Underorequal</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #UNDEROREQUAL_VALUE
   * @generated
   * @ordered
   */
  UNDEROREQUAL(5, "underorequal", "<=");
   ...
   * <!-- end-user-doc -->
   * @see #UNDER
   * @model name="under" literal="<"
   * @generated
   * @ordered
   */
  public static final int UNDER_VALUE = 1;
  ...
  /**
   * The '<em><b>Overorequal</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Overorequal</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #OVEROREQUAL
   * @model name="overorequal" literal=">="
   * @generated
   * @ordered
   */
  public static final int OVEROREQUAL_VALUE = 4;

  /**
   * The '<em><b>Underorequal</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Underorequal</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #UNDEROREQUAL
   * @model name="underorequal" literal="<="
   * @generated
   * @ordered
   */
  public static final int UNDEROREQUAL_VALUE = 5;
  ...
  public static RelationType get(int value)
  {
    switch (value)
    {
      ...
      case OVEROREQUAL_VALUE: return OVEROREQUAL;
      case UNDEROREQUAL_VALUE: return UNDEROREQUAL;
    }
    return null;
  }
