...
public class TestuaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TestuaGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Entity___LeftSquareBracketKeyword_5_0_RightSquareBracketKeyword_5_2__q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (TestuaGrammarAccess) access;
