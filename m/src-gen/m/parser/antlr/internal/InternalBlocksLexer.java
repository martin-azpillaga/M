...
public class InternalBlocksLexer extends Lexer {
    ...
    public final void mRULE_N() throws RecognitionException {
        try {
            int _type = RULE_N;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlocks.g:340:8: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? )
            // InternalBlocks.g:340:10: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )?
            {
            // InternalBlocks.g:340:10: ( '-' )?
            int alt1=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalBlocks.g:340:28: '.' ( '0' .. '9' )*
                    {
                    match('.'); 
                    // InternalBlocks.g:340:32: ( '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlocks.g:342:9: ( ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' )* )
            // InternalBlocks.g:342:11: ( '_' | 'a' .. 'z' | 'A' .. 'Z' ) ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' )*
            {
            ...
            // InternalBlocks.g:342:35: ( '_' | 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '-' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_WHITE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlocks.g:344:18: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
            // InternalBlocks.g:344:20: ( ' ' | '\\t' | '\\r' | '\\n' )
            {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlocks.g:346:13: ( ( '\"' ( options {greedy=false; } : . )* '\"' | '\\'' ( options {greedy=false; } : . )* '\\'' ) )
            // InternalBlocks.g:346:15: ( '\"' ( options {greedy=false; } : . )* '\"' | '\\'' ( options {greedy=false; } : . )* '\\'' )
            {
            // InternalBlocks.g:346:15: ( '\"' ( options {greedy=false; } : . )* '\"' | '\\'' ( options {greedy=false; } : . )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalBlocks.g:346:16: '\"' ( options {greedy=false; } : . )* '\"'
                    {
                    match('\"'); 
                    // InternalBlocks.g:346:20: ( options {greedy=false; } : . )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    break;
                case 2 :
                    // InternalBlocks.g:346:56: '\\'' ( options {greedy=false; } : . )* '\\''
                    {
                    match('\''); 
                    // InternalBlocks.g:346:61: ( options {greedy=false; } : . )*
                    loop7:
                    do {
                        int alt7=2;
    ...
    static final String[] DFA9_transitionS = {
            "\2\7\2\uffff\1\7\22\uffff\1\7\1\uffff\1\10\4\uffff\1\10\5\uffff\1\5\1\uffff\1\2\12\5\2\uffff\1\1\1\4\1\3\2\uffff\32\6\4\uffff\1\6\1\uffff\32\6",
            "\1\11",
            "",
            "",
            "",
