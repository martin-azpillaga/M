...
public class TextFormatter extends AbstractFormatter2 {
  ...
  protected void _format(final Entity entity, @Extension final IFormattableDocument document) {
    ...
    List<String> rendering = Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("position", "rotation", "scale", "mesh", "material", "number"));
    List<String> physics = Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("mass", "restitution", "friction", "extents", "radius", "triggerZone"));
    Component last = null;
    EList<Component> _components = entity.getComponents();
    for (final Component component : _components) {
      {
        if ((last != null)) {
          if ((rendering.contains(last.getName()) && (!rendering.contains(component.getName())))) {
            final Procedure1<IHiddenRegionFormatter> _function_6 = (IHiddenRegionFormatter it) -> {
              it.newLine();
            };
            document.<Component>prepend(component, _function_6);
          } else {
            if ((physics.contains(last.getName()) && (!physics.contains(component.getName())))) {
              final Procedure1<IHiddenRegionFormatter> _function_7 = (IHiddenRegionFormatter it) -> {
                it.newLine();
              };
              document.<Component>prepend(component, _function_7);
            } else {
              if (((((last.getValue() != null) && (component.getValue() == null)) && (!physics.contains(last.getName()))) && (!rendering.contains(last.getName())))) {
                final Procedure1<IHiddenRegionFormatter> _function_8 = (IHiddenRegionFormatter it) -> {
                  it.newLine();
                };
                document.<Component>prepend(component, _function_8);
              } else {
                if (((last.getValue() == null) && (component.getValue() != null))) {
                  final Procedure1<IHiddenRegionFormatter> _function_9 = (IHiddenRegionFormatter it) -> {
                    it.newLine();
                  };
                  document.<Component>prepend(component, _function_9);
                }
              }
            }
          }
  ...
  protected void _format(final And and, @Extension final IFormattableDocument document) {
    ...
    document.surround(this.textRegionExtensions.regionFor(and).keyword("&&"), _function);
    document.<Expression>format(and.getLeft());
    document.<Expression>format(and.getRight());
  }
  ...
  protected void _format(final Or or, @Extension final IFormattableDocument document) {
    ...
    document.surround(this.textRegionExtensions.regionFor(or).keyword("||"), _function);
    document.<Expression>format(or.getLeft());
    document.<Expression>format(or.getRight());
  }
  ...
  protected void _format(final Not not, @Extension final IFormattableDocument document) {
    ...
    document.append(this.textRegionExtensions.regionFor(not).keyword("!"), _function);
    document.<Expression>format(not.getExpression());
  }
  
  protected void _format(final Comparison comparison, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(comparison).assignment(this.access.getAtomicBAccess().getTypeAssignment_1_1()), _function);
    document.<Expression>format(comparison.getLeft());
    document.<Expression>format(comparison.getRight());
  }
  ...
  protected void _format(final Plus plus, @Extension final IFormattableDocument document) {
    ...
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("+"), _function);
    document.<Expression>format(plus.getLeft());
    document.<Expression>format(plus.getRight());
  }
  
  protected void _format(final Minus plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("-"), _function);
  ...
  protected void _format(final Times plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("*"), _function);
  ...
  protected void _format(final Divide plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("/"), _function);
  ...
  protected void _format(final Bitwise plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("&"), _function);
    ...
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("|"), _function_1);
    final Procedure1<IHiddenRegionFormatter> _function_2 = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("^"), _function_2);
    final Procedure1<IHiddenRegionFormatter> _function_3 = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword("<<"), _function_3);
    final Procedure1<IHiddenRegionFormatter> _function_4 = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.surround(this.textRegionExtensions.regionFor(plus).keyword(">>"), _function_4);
    document.<Expression>format(plus.getLeft());
    document.<Expression>format(plus.getRight());
  }
  
  protected void _format(final BitwiseNegate plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.oneSpace();
    };
    document.append(this.textRegionExtensions.regionFor(plus).keyword("~"), _function);
    document.<Expression>format(plus.getExpression());
  }
  
  protected void _format(final Increment plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.noSpace();
    };
    document.prepend(this.textRegionExtensions.regionFor(plus).keyword("++"), _function);
    document.<Expression>format(plus.getExpression());
  }
  
  protected void _format(final Decrement plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.noSpace();
    };
    document.prepend(this.textRegionExtensions.regionFor(plus).keyword("~"), _function);
  ...
  protected void _format(final Brackets plus, @Extension final IFormattableDocument document) {
    final Procedure1<IHiddenRegionFormatter> _function = (IHiddenRegionFormatter it) -> {
      it.noSpace();
    };
    document.append(this.textRegionExtensions.regionFor(plus).keyword("("), _function);
    ...
    document.prepend(this.textRegionExtensions.regionFor(plus).keyword(")"), _function_1);
    document.<Expression>format(plus.getExpression());
  }
  ...
  public void format(final Object access, final IFormattableDocument document) {
    if (access instanceof XtextResource) {
      ...
      return;
    } else if (access instanceof And) {
      _format((And)access, document);
      return;
    } else if (access instanceof Assignment) {
      _format((Assignment)access, document);
      return;
    } else if (access instanceof Bitwise) {
      _format((Bitwise)access, document);
      return;
    } else if (access instanceof BitwiseNegate) {
      _format((BitwiseNegate)access, document);
      return;
    } else if (access instanceof Brackets) {
      _format((Brackets)access, document);
      return;
      ...
      return;
    } else if (access instanceof Comparison) {
      _format((Comparison)access, document);
      return;
    } else if (access instanceof Decrement) {
      _format((Decrement)access, document);
      return;
    } else if (access instanceof Divide) {
      _format((Divide)access, document);
      return;
    } else if (access instanceof Increment) {
      _format((Increment)access, document);
      return;
    } else if (access instanceof Loop) {
      _format((Loop)access, document);
      return;
    } else if (access instanceof Minus) {
      _format((Minus)access, document);
      return;
    } else if (access instanceof Not) {
      _format((Not)access, document);
      return;
    } else if (access instanceof Or) {
      _format((Or)access, document);
      return;
    } else if (access instanceof Plus) {
      _format((Plus)access, document);
      return;
    } else if (access instanceof Times) {
      _format((Times)access, document);
      return;
