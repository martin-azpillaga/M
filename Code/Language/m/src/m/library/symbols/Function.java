...
public enum Function implements Symbol
{
	...
	SCREEN_OVERLAPS(ENTITY_LIST, NUMBER3),
	...
	ACTIVATE_PARAMETER(UNIT, ENTITY, STRING),
	DEACTIVATE_PARAMETER(UNIT, ENTITY, STRING),
	PLAY_ANIMATION(UNIT, ENTITY, STRING),
	...
	WORLD_TO_VIEWPORT(NUMBER3, NUMBER3),
	VIEWPORT_TO_WORLD(NUMBER3, NUMBER3),
	
	TO_STRING(STRING, NUMBER),
	TO_NUMBER(NUMBER, STRING),
	
	IS_ZERO(PROPOSITION, NUMBER),
	IS_POSITIVE(PROPOSITION, NUMBER),
	IS_NEGATIVE(PROPOSITION, NUMBER),
	
	OVER(PROPOSITION, ENTITY),
