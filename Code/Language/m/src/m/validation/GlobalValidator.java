...
public class GlobalValidator
{
    ...
    public GlobalData validate(String modifiedFile, FileData modifiedData)
    {
        var affectedNodes = invalidateObsoleteMemory(modifiedFile);

        affectedNodes.addAll(modifiedData.nodes);

        validate(affectedNodes, modifiedFile);
    ...
    {
        var affectedNodes = invalidateObsoleteMemory(file);
        
        validate(affectedNodes, null);
