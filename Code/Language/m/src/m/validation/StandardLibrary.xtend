...
class StandardLibrary
{
	...
	public static val Euskara = new StandardLibrary=>
	[
		symbols = #
		[
			inputTriggered=>[name="inputaAktibo"],
            inputValue=>[name="inputValue"],
            inputVector=>[name="inputBektorea"],
	
            timer=>[name="denbora"],
            elapsed=>[name="iragandakoDenbora"],
            timeout=>[name="denboraAmaituta"],
	
            position=>[name="kokapena"],
            rotation=>[name="biraketa"],
            scale=>[name="eskala"],
            worldPosition=>[name="kokapenGlobala"],
            worldRotation=>[name="birapenGlobala"],
            worldScale=>[name="eskalaGlobala"],
            parent=>[name="gurasoa"],
            children=>[name="umeak"],
