...
export default new ContainerModule(bind => {
    ...
    bind<LanguageServerContribution>(LanguageServerContribution).to(NContribution);
});
...
class DSLContribution extends BaseLanguageServerContribution {
    ...
    start(clientConnection: IConnection): void {
        ...
        if (socketPort) {
            ...
            const jar = path.resolve(__dirname, '../../build/Language-2019-ls.jar');
...
@injectable()
class NContribution extends BaseLanguageServerContribution {
