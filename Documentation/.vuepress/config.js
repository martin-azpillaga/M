module.exports = {
    ...
    themeConfig: {
      ...
      nav: [
        { text: 'Starter guide', link: '/0. Starter guide/0. Set up' },
        { text: 'User guide', link: '/1. User guide/0. How to/0. Transforms' },
        { text: 'Developer guide', link: '/2. Developer guide/0. Philosophy/0. Motivation' }
      ],
      sidebar: {
        '/0. Starter guide/': [
          '0. Set up',
