...
``` m
    ...
    playground contains
        ...
        pinky based on ghost without demoMode has position 0 5 appearance
         sprite.pinky normalAppearance sprite.pinky independenceTime 2s.
        blinky based on ghost without demoMode has position 5 5 appearance
         sprite.blinky normalAppearance sprite.blinky independenceTime 4s.
        inky based on ghost without demoMode has position -5 5 appearance
         sprite.inky normalAppearance sprite.inky independenceTime 6s.
        clyde based on ghost without demoMode has position 0 5 appearance
         sprite.clyde normalAppearance sprite.clyde independenceTime 8s.

        leftWish based on directionChange has button gamepad.left
         direction -2 0.
        rightWish based on directionChange has button gamepad.right
         direction 2 0.
        upWish based on directionChange has button gamepad.up
         direction 0 2.
        downWish based on directionChange has button gamepad.down
         direction 0 -2.
