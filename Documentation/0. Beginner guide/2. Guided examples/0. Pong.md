...
[
    ∀ a
    [
        a.velocity ≔ a.baseVelocity × a.velocityInputRange
    ]
]
...
[
    ...
    [
        ...
        myLength ≔ random[a.serveLength]
        a.velocity ≔ [cos[α], sin[α], a.z] × myLength
...
restart≔
[
    A ≔ {a | a.maxNumber > a.maxNumber}

    → ¬empty[A]
    [
        ∀ b
        [
            b.number ≔ b.number + b.resetNumber
        ]
    ]
]

body ≔ {mesh, material, mass, extents, restitution}

paddle ≔ body ∪ {baseVelocity, velocityInput, velocityInputRange}
ball ≔ body ∪ {serveSignal, serveAngle, serveLength, z, respawnPosition, scoreApplier, collisions}
goal ≔ body ∪ {extents, respawnApplier, collisions, worth, boards}

board ≔ {number, maxNumber, resetNumber}

player ≔ {viewAngle, viewDistance, clearColor}
